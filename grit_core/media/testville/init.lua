...
material `RoadSurface` { diffuseMap=`RedBrickVert_d.dds`, normalMap=`RedBrick_n.dds` }
material `RoofTiles` { diffuseMap=`/common/tex/davec/RoofTiles_d.dds`, diffuseColour=srgb(248, 253, 255), textureScale={.25,.25} }
