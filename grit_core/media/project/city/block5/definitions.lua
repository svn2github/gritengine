...
material `/project/city/block5/meshes/block1` { diffuseMap=`textures/block1.png`}

-- Lot 21
material `/project/DEFAULT` { diffuseColour={1,1,1}, specularColour={1,1,1}, gloss=15 }
material `/project/Hotel` { diffuseMap=`textures/hotel_d.png`, normalMap=`textures/hotel_n.png`, specularFromDiffuse = {-0.25, 0.1}, specularity=20,  }
material `/project/Hotel_roof` { diffuseMap=`textures/hotel_roof_d.png`, specularFromDiffuse = {0.25, 0.1}, specularity=20,  }
-- end lot 21
