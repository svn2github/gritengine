...
editor_interface.toolbar:addSeparator()
editor_interface.toolbar:addTool("Select", "/editor/core/icons/select.png", (function(self) widget.mode = 0 end), "")
editor_interface.toolbar:addTool("Translate", "/editor/core/icons/translate.png", (function(self) widget.mode = 1 end), "")
editor_interface.toolbar:addTool("Rotate", "/editor/core/icons/rotate.png", (function(self) widget.mode = 2 end), "")
editor_interface.toolbar:addTool("Scale", "/editor/core/icons/scale.png", (function(self) widget.mode = 3 end), "")
editor_interface.toolbar:addSeparator()
