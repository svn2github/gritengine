include `/playground/img/definitions.lua`
include `/playground/img/buildings/definitions.lua`
include `/detached/weapons/init.lua`
include `/detached/characters/init.lua`

include `/playground/pickups.lua`
...
function playground:init()
    ...
    include `/playground/img/placement.lua`
