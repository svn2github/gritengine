...
material `Grey` { diffuseMask = vec(0.2, 0.2, 0.2), specularMask = 0.04, glossMask = 0.2 }
material `Dark Grey` { diffuseMask = vec(0.2, 0.2, 0.2), specularMask = 0.04, }
material `Headlight` { glossMask = g, specularMask = s}
material `ReverseLight` { glossMask = g, specularMask = s}
material `Brakelight` { diffuseMask = vec(1,0,0), glossMask = g, specularMask = s}
material `Turnlight` { diffuseMask = vec(1.0,0.597,0), glossMask = g, specularMask = s}
material `Window` { diffuseMask = vec(0.035, 0.035, 0.035), glossMask = 1, specularMask = 0.045}
